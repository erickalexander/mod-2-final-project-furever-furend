...
dog_26 = Dog.create(personality: 'Bright, patient, loving, and family oriented', energy_level: 'Somewhat active', children_friendly: true, dog_friendly: false, size:'l', barking_level: 2, breed: 'Leonberger', link: 'http://www.dogbreedslist.info/uploads/allimg/dog-pictures/Leonberger-2.jpg')
dog_27 = Dog.create(personality: 'Calm, dignified, kindly; courageous but not aggressive', energy_level: 'Somewhat active', children_friendly: false, dog_friendly: false, size: 'l', barking_level: 2, breed: 'Irish Wolfhound', link: 'http://www.dogbreedslist.info/uploads/allimg/dog-pictures/Irish-Wolfhound-2.jpg')
dog_28 = Dog.create(personality: 'Dignified, gentle, polite; quietly intelligent and perceptive', energy_level: 'Somewhat active', children_friendly: false, dog_friendly: true, size: 'l', barking_level: 2, breed: 'Scottish Deerhound', link: 'http://www.dogbreedslist.info/uploads/allimg/dog-pictures/Scottish-Deerhound-2.jpg')
